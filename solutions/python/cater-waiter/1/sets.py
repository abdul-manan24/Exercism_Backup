...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    cleaned_ingredients.append(dish_name)
    cleaned_ingredients.append(set(dish_ingredients))

    return tuple(cleaned_ingredients)
...
def tag_special_ingredients(dish):
    ...
    ingredients = set(ingredients) & SPECIAL_INGREDIENTS
...
def separate_appetizers(dishes, appetizers):
    ...
    dishes = set(dishes) - set(appetizers)
...
def singleton_ingredients(dishes, intersection):
    ...
    for ingredients in dishes:
        ...
        singleton_ingredients_set |= ingredients
