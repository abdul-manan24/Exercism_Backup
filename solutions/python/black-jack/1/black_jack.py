...
def value_of_ace(card_one, card_two):
    ...
    if card_one not in ('J', 'K', 'Q', 'A') and card_two not in ('J', 'K', 'Q', 'A'):
...
def can_split_pairs(card_one, card_two):
   ...
   Returns:
    ...
    if card_one == card_two:
        return True
    if card_one in ('J', 'K', 'Q') and card_two == 10 or card_two in ('J', 'K', 'Q'):
        return True
    if card_two in ('J', 'K', 'Q') and card_one == 10 or card_one in ('J', 'K', 'Q'):
        return True
...
def can_double_down(card_one, card_two):
    ...
    if card_two == 'A':
        card_two = 1
    if (int(card_one) + int(card_two)) in (9, 10, 11):
        return True
    return False
