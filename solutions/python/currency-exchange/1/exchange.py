...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchange_rate_with_spread = (exchange_rate/100 * spread) + exchange_rate
    
    exchangeable_amount = (budget/exchange_rate_with_spread) - ((budget/exchange_rate_with_spread) % denomination)
