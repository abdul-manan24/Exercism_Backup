...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    percentage_of_reactor_efficiency = (generated_power/theoretical_max_power) * 100

    if percentage_of_reactor_efficiency >= 80:
        return 'green'
    elif 60 <= percentage_of_reactor_efficiency < 80:
        return 'orange'
    elif 30 <= percentage_of_reactor_efficiency < 60:
        return 'red'
    else:
        return 'black'
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    ten_percent_of_threshold = threshold - ninety_percent_of_threshold

    if (temperature * neutrons_produced_per_second) < ninety_percent_of_threshold:
        return 'LOW'
    elif ninety_percent_of_threshold <= (temperature * neutrons_produced_per_second) <= (threshold + ten_percent_of_threshold):
        return 'NORMAL'
    else:
        return 'DANGER'
